...
let favoriteFoods = ['ice cream', 'banh mi', 'sushi', 'reuben', 'peanutbutter'];
...
favoriteFoods.push('raspberries');
console.log('Added another favorite to the end:', favoriteFoods );
...
console.log('The foods in the array are now', favoriteFoods );
